# -*- coding: utf-8 -*-
"""
Created on Wed Dec 11 18:21:51 2019
...
def main():
    ...
    print("NFL Quarterback Tool")
    print("Created by Ujwal Gupta, Carl Jeanty, Quest Hollis, Jonathan Ramirez")
    print("Directions: Enter a quarterback's first name and last name. Then select between the following options down below")
    ...
    for item in lst:
        if "--" in item:
            ...
            newLst.append(item)
    for year in newLst:
        x_1 = [t for t in newLst if t[0]==1972]
    for i in newLst:
        list1.append(i[0])
        list2.append(i[1])
